...
int lssp_solver_gpbicr(LSSP_SOLVER & solver, LSSP_PC & pc)
{
    ...
    for (iter = 1; iter <= maxiter; iter++) {
        ...
        if (solver.verb >= 1) {
            lssp_printf("gpbicr: itr: %5d, abs res: %.6e, rel res: %.6e\n", iter, nrm2, nrm2 / ires);
        }
